...
- 追查 API
    ...
    - **Day11 - [追查 API] Burp Suite 監聽封包**
        - 介紹原理、使用方式，Https的受限
    - **Day12 - [追查 API] 好用的 Pretty 工具推薦**
        - 格式化、解碼、編碼工具
        - API 來的資料有時候不乾淨，json 需要排版，或去雙引號、解base64之類的
    - **Day13 - [追查 API] PACAndroid**
...
- Debug: 
    ...
    - **Day15 - [Debug] Log vs Toast**
        - Log 不需要 Context，Toast 需要 Context
        - Log 比較通用，可以觀察執行緒的順序
        - Toast 不需要插線，方邊觀察，也方便非工程師觀察
    - **Day16 - [Debug] Device Exploer**
        - APP 寫檔的儲存位置
        - 寫檔、看檔
    - **Day17 - [Debug] SQLite**
        - App Inspection > Database Inspector
    - **Day18 - [Debug] Debugger、斷點**
    - **Day19 - [Debug] Share Preference**
        - 其實是寫檔、檔案位置
    - **##Day20 - [Debug] ADB 環境變數**
- Work with Legacy Code
    - 很多時候 Code 不是自己寫的，這時候就需要看別人的 Code
    - **Day21 - [Coding] Android Studio Code Template**
        - PPPP
        - PP
    - **Day22 - [Coding] 寫註解**
        - 寫 Java doc 格式註解的好處
