...
- UI
    ...
    - **Day - [UI] 確認對齊、Padding、點擊範圍**
        - 「顯示版面配置界限」，手機上簡易檢查 UI 是否對齊、點擊範圍、padding
        - Layout Inspector，檢查元件長寬、visibility
    - **Day - [UI] Android Studio Code Template**
        - PPPP
        - PP
    - **Day - [UI] Constraint Layout Basline**
    ...
    - **Day - [UI] Android Studio 內建的 Color Picker**
        - 好處：透明度百分比直接換算 16 進制
    - **Day - [UI] 大小手機問題**
...
- 追查 API
    ...
    - **Day - [追查 API] Burp Suite 監聽封包**
        - 介紹原理、使用方式，Https的受限
    - **Day - [追查 API] 好用的 Pretty 工具推薦**
        - 格式化、解碼、編碼工具
        - API 來的資料有時候不乾淨，json 需要排版，或去雙引號、解base64之類的
    - **Day - [追查 API] PACAndroid**
...
- 版本控管
    ...
    - **Day [版本控管] 忍不住順手修掉其他 Bug (Shelves)**
